...
const Header = () => {
  return (
    <header className="text-gray-300 fixed top-0 left-0 w-full bg-[#0D141F] bg-opacity-80 backdrop-blur-md shadow-md z-50 border-b">
      <nav className="max-w-6xl mx-auto flex justify-between items-center p-4">
        <div className="text-xl text-gray-300 font-bold border-t-8 border-0"><strong className="text-1xl">@</strong>/////</div>
